...
class FilmActor(models.Model):
    actor = models.OneToOneField(Actor, on_delete=models.DO_NOTHING, primary_key=True)
...
class FilmCategory(models.Model):
    film = models.OneToOneField(Film, on_delete=models.DO_NOTHING, primary_key=True)
...
class Store(models.Model):
    ...
    manager_staff = models.OneToOneField(Staff, on_delete=models.DO_NOTHING)
    address = models.ForeignKey(Address, on_delete=models.DO_NOTHING)
    last_update = models.DateTimeField()
